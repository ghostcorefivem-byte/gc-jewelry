...
1. Use **illenium-appearance**
2. Zoom into the jewelry
3. Take a screenshot
4. Use a tool like PhotoRoom to remove background
5. Resize to **128x128**
...
1. Walk up to a player
2. Open target
3. Click **Snatch Chain**
4. Confirm
...
✔ Prevents items from appearing in clothing menu
✔ Forces usage through GC-Jewelry
